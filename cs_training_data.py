...
course1 = Course(name = 'The Complete Android N Developer Course', 
    description = 'Learn to make and market apps for Android 7 Nougat by building real apps including Uber, Whatsapp and Instagram clones.', 
...
course2 = Course(name = 'The Complete iOS 10 Developer Course', 
    description = 'Use Xcode 8 & Swift 3 to make real apps like Uber, Instagram & Flappy Bird. Includes free web hosting, assets & ebook.', 
...
course3 = Course(name = 'Ultimate Ionic 3 - Build iOS and Android Apps with Angular 4', 
    description = 'Fast track your iOS and Android mobile app development with the Ionic 3 Framework plus the power Angular 4, HTML and CSS', 
...
course4 = Course(name = 'Android Material Design', 
    description = 'Material design is a comprehensive guide for visual, motion, and interaction design across platforms and devices. This course talks about all the important material design specifications, colors, design guidelines, and also using material widgets along with material themes.', 
...
course2 = Course(name = 'Git Complete: The definitive, step-by-step guide to Git', 
    description = 'This course is designed to be a comprehensive approach to Git, which means no prior knowledge or experience is required but students will emerge at the end with a very solid understanding and hands-on experience with Git and related source control concepts.', 
...
course1 = Course(name = 'Data Science and Machine Learning with Python - Hands On!', 
    description = 'Become a data scientist in the tech industry! Comprehensive data mining and machine learning course with Python & Spark.', 
...
course2 = Course(name = 'Python for Data Science and Machine Learning Bootcamp', 
    description = 'Learn how to use NumPy, Pandas, Seaborn , Matplotlib , Plotly , Scikit-Learn , Machine Learning, Tensorflow , and more! This comprehensive course will be your guide to learning how to use the power of Python to analyze data, create beautiful visualizations, and use powerful machine learning algorithms. This course is designed for both beginners with some programming experience or experienced developers looking to make the jump to Data Science.', 
